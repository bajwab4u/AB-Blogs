...
$sql="SELECT id,name,title,body,category,likes,time FROM userblog  WHERE category='Education' ORDER BY time ASC";
...
$sql="SELECT id,name,title,body,category,likes,time FROM userblog  WHERE category='Education' ORDER BY likes DESC ";
...
$sql="SELECT id,name,title,body,category,likes,time FROM userblog  WHERE category='Education' ORDER BY time DESC";
