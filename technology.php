...
$sql="SELECT id,name,title,body,category,likes,time FROM userblog  WHERE category='Technology' ORDER BY time ASC";
...
$sql="SELECT id,name,title,body,category,likes,time FROM userblog  WHERE category='Technology' ORDER BY likes DESC ";
...
$sql="SELECT id,name,title,body,category,likes,time FROM userblog  WHERE category='Technology' ORDER BY time DESC";
